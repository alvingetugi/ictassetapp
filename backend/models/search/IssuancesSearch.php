...
/**
 * IssuancesSearch represents the model behind the search form of `common\models\Issuances`.
 */
class IssuancesSearch extends Issuances
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['code', 'issuancedate', 'comments', 'modelID', 'serialnumber', 'accessorylistID', 'userID'], 'safe'],
        ];
    }

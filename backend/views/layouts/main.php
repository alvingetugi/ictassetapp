            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?php echo \yii\helpers\Url::to(['/assetmakes/index']) ?>">
                                <i class="fas fa-fw fa-chart-area"></i>
                                <span>Makes</span>
                            </a>
                            <a class="collapse-item" href="<?php echo \yii\helpers\Url::to(['/assetmodels/index']) ?>">
                                <i class="fas fa-fw fa-chart-area"></i>
                                <span>Models</span>
                            </a>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFour"
                        ...
                        <i class="fas fa-fw fa-cog"></i>
                        <span>Remedial Acion Plans</span>
                    </a>
                    <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?php echo \yii\helpers\Url::to(['/rappayments/index']) ?>">
                                <i class="fas fa-fw fa-chart-area"></i>
                                <span>RAP Payments</span>
                            </a>
                            <a class="collapse-item" href="<?php echo \yii\helpers\Url::to(['/raptypes/index']) ?>">
                                <i class="fas fa-fw fa-chart-area"></i>
                                <span>RAP Types</span>
                            </a>
                        </div>

                ...
                <!-- <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Issuances
                                    </div>
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
            ...
            <!-- <div class="row"> -->
                ...
                <!-- <div class="col-xl-8 col-lg-7">
                    <div class="card shadow mb-4"> -->
                        ...
                        <!-- <div
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Assets Depreciation Trend</h6>
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="#">Other Assets</a>
                                </div>
                            </div>
                        </div> -->
                        <!-- Card Body -->
                ...
                <!-- <div class="col-xl-4 col-lg-5">
                    <div class="card shadow mb-4"> -->
                        ...
                        <!-- <div
                            class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Funding Sources</h6>
                            <div class="dropdown no-arrow">
                                <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="#">Other Sources</a>
                                </div>
                            </div>
                        </div> -->
                        <!-- Card Body -->
                        <!-- <div class="card-body">
                            ...
                            <div class="mt-4 text-center small">
                                ...
                                <span class="mr-2">
                                    <i class="fas fa-circle text-info"></i> Disposals
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <!-- <div class="row"> -->
                ...
                <!-- <div class="col-lg-6 mb-4"> -->
                    ...
                    <!-- <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <h4 class="small font-weight-bold">Equipment Servicing <span
                                    class="float-right">20%</span></h4>
                            <div class="progress mb-4">
                                <div class="progress-bar bg-danger" role="progressbar" style="width: 20%"
                                    aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <h4 class="small font-weight-bold">Equipment Tracking <span
                                    class="float-right">40%</span></h4>
                            <div class="progress mb-4">
                                <div class="progress-bar bg-warning" role="progressbar" style="width: 40%"
                                    aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <h4 class="small font-weight-bold">Asset Overhaul <span
                                    class="float-right">60%</span></h4>
                            <div class="progress mb-4">
                                <div class="progress-bar" role="progressbar" style="width: 60%"
                                    aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <h4 class="small font-weight-bold">Maintenance Plans <span
